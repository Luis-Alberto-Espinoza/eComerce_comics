...
import com.comicsmarket.apirest.services.UsuarioService;

@RestController
@CrossOrigin(origins = "*")
@RequestMapping(path = "api/comicsmarket/usuarios")
public class UsuarioController {
	...
	@PutMapping("/{id}")
	public ResponseEntity <?> edit(@PathVariable Long id, @RequestBody Usuario entity){
		try {
