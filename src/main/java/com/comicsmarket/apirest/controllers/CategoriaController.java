...
import com.comicsmarket.apirest.services.CategoriaService;

@RestController
@CrossOrigin(origins = "*")
@RequestMapping(path = "api/comicsmarket/categorias")
public class CategoriaController {
	...
	@PutMapping("/{id}")
	public ResponseEntity <?> edit(@PathVariable Long id, @RequestBody Categoria entity){
		try {
